        ...
        <div className="max-w-[1360px] mx-auto px-4 sm:px-8">
          ...
          <div className="text-center max-w-xl mx-auto mb-10">
            ...
            <h1 className="text-[32px] sm:text-[42px] font-extrabold tracking-tight text-[#0a1628]">
              Three simple steps to decode your prescription
            </h1>
            <p className="mt-3 text-[16px] text-slate-500">
              Learn how our multi-model vision AI transforms handwriting into clear medical schedules.
            </p>
          </div>

          {/* 3 Step Interactive Visual Component */}
          ...
          <div className="text-center py-10">
            ...
            >
              <ScanLine size={18} />
              <span>Scan Your Prescription Now</span>
              <ArrowRight size={18} />
            </Link>
          </div>
        </div>
